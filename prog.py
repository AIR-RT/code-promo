...
# serveur 
sender_email = "xxxx" # the e-mail that will send the message
...
smtp_username = 'xxxx' # 95% of time this is the sender_email
smtp_password = 'xxxxxx'  # the pass of the sender e-mail
